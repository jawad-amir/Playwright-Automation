...
class MailchimpProvider extends Provider {
   ...
   * @type {string}
   */
  authUrl = 'https://us10.admin.mailchimp.com/account/billing-history/';

  /**
   * @private
   * @type {string}
   */
  baseUrl = 'https://us10.admin.mailchimp.com/i/account/billing-history/';

  /**
   * @private
   * @type {string}
   */
  downloadBase = 'https://us10.admin.mailchimp.com/i';
