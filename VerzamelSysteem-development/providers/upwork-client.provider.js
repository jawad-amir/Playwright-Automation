...
class UpworkClientProvider extends Provider {
  /**
  * @private
  * @type {string}
  */
  ...
  */
  ...
  /**
    ...
    * @type {string}
  */
  clientUrl = 'https://www.upwork.com/nx/client/dashboard/';

  /**
    * @private
    * @type {string}
    */
  invAccUrl = 'https://www.upwork.com/nx/category/';
  ...
  */
  ...
  async handle2FA(code) {
    try {
      ...
      try {
        await this.page.waitForURL('https://www.upwork.com/nx/**');
        this.authDone = true;
      } catch (e) {
  ...
  async authenticate() {
    try {
      ...
      const url = this.page.url();
      if (url.indexOf(this.clientUrl) !== -1 || url.indexOf(this.invAccUrl) !== -1) {
        this.authDone = true;
      }
...
module.exports = UpworkClientProvider;
